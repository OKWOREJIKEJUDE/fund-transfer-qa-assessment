...
- Security testing (authentication, authorisation, input validation, replay attacks, rate limiting)
...
- Failure to generate an audit record for every successful transfer, violating business rule 6
